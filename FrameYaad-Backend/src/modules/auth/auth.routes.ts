...
authRouter.post("/employee/login", validateBody(loginSchema), controller.loginEmployee);
authRouter.post("/staff/login", validateBody(loginSchema), controller.loginStaff);
